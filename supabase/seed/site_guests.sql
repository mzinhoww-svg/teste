...
--
-- As fotos JÁ ESTÃO no repositório, em `public/convidados/` — servidas pelo
-- próprio site, sem Storage e sem copiar URL. Nada a subir.
--
...
values
  ('Cátia Damasceno',   null, '/convidados/catia-damasceno.webp',  1, false),
  ('Bruna Ghetti',      null, '/convidados/bruna-ghetti.webp',     2, false),
  ('Flávia Alessandra', null, '/convidados/flavia-alessandra.webp', 3, false)
