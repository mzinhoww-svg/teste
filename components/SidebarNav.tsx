...
import {
  ...
  Receipt, BarChart3, Zap, Bot, Settings, ScrollText, HelpCircle, CheckSquare, type LucideIcon,
} from "lucide-react";
import { NAV_GROUPS, type NavItem } from "@/lib/nav-items";

const ICONS: Record<string, LucideIcon> = {
  Filter, Users, Building2, FileSignature, FolderKanban, PackageCheck,
  Receipt, BarChart3, Zap, Bot, Settings, ScrollText, HelpCircle, CheckSquare,
};
